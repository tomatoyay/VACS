...
func update_text(text:String):
	...
	if skip == 0:
		...
		text_speed = 0.000000000000000000000000000000001
...
func load_theme(theme: ConfigFile):
	...
	text_label.set('custom_fonts/bold_italics_font', DialogicUtil.path_fixer_load(theme.get_value('text', 'bold_italic_font', 'res://addons/dialogic/Example Assets/Fonts/DefaultBoldItalicFont.tres')))
